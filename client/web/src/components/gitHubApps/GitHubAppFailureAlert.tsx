...
export const GitHubAppFailureAlert: React.FunctionComponent<{ error: string }> = ({ error }) => (
    <DismissibleAlert className="mb-3" variant="danger">
        <div>
            <H4>Your GitHub App did not finish connecting to Sourcegraph correctly.</H4>
          <Text className="m-0">The following error occurred during setup: <Text>{error}</Text></Text>
