...
export const GitHubAppFailureAlert: React.FunctionComponent<React.PropsWithChildren<{ error: string }>> = ({
    ...
    <DismissibleAlert className="mb-3" variant="danger">
        <div>
            ...
            <Text className="m-0"><Text className="m-0">The following error occurred during setup: {error}</Text></Text>
            <Text className="m-0"><Text className="m-0">You may need to remove the GitHub App and try again.</Text></Text>
        </div>
    </DismissibleAlert>
)
